...
function webAuthnSigDataBytes(sig) {
 ...
 */
export function buildAuthPayloadScVal(spec) {
    ...
    const contextRuleIdsVec = xdr.ScVal.scvVec(spec.contextRuleIds.map((id) => xdr.ScVal.scvU32(id)));
...
//# sourceMappingURL=multiSigner.js.map