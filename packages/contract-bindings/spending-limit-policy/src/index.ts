...
export interface Client {
   ...
   */
  install: ({install_params, context_rule, smart_account}: {install_params: SpendingLimitAccountParams, context_rule: ContextRule, smart_account: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a get_spending_limit transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  get_spending_limit: ({context_rule_id, smart_account}: {context_rule_id: u32, smart_account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Option<SpendingLimitAccountParams>>>

  /**
   * Construct and simulate a set_spending_limit transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   * which resets it.
   */
  set_spending_limit: ({spending_limit, context_rule, smart_account}: {spending_limit: i128, context_rule: ContextRule, smart_account: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAHZW5mb3JjZQAAAAAEAAAAAAAAAAdjb250ZXh0AAAAB9AAAAAHQ29udGV4dAAAAAAAAAAAFWF1dGhlbnRpY2F0ZWRfc2lnbmVycwAAAAAAA+oAAAfQAAAABlNpZ25lcgAAAAAAAAAAAAxjb250ZXh0X3J1bGUAAAfQAAAAC0NvbnRleHRSdWxlAAAAAAAAAAANc21hcnRfYWNjb3VudAAAAAAAABMAAAAA",
        "AAAAAAAAAAAAAAAHaW5zdGFsbAAAAAADAAAAAAAAAA5pbnN0YWxsX3BhcmFtcwAAAAAH0AAAABpTcGVuZGluZ0xpbWl0QWNjb3VudFBhcmFtcwAAAAAAAAAAAAxjb250ZXh0X3J1bGUAAAfQAAAAC0NvbnRleHRSdWxlAAAAAAAAAAANc21hcnRfYWNjb3VudAAAAAAAABMAAAAA",
        ...
        "",
        "",
  ...
  public readonly fromJSON = {
    enforce: this.txFromJSON<null>,
        ...
        get_spending_limit: this.txFromJSON<Option<SpendingLimitAccountParams>>,
        set_spending_limit: this.txFromJSON<null>
  }
}